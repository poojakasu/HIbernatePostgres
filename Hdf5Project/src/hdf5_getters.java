...
{
	public static String attributes = "artist_familiarity,artist_hotttnesss,artist_id,"
			+ "artist_mbid,artist_playmeid,artist_7digitalid,"
			+ "artist_latitude,artist_longitude,artist_location,name,"
			+ "release,release_7digitalid,"
			+ "song_hottness,title,track_7digitalid,similar_artists,"
			+ "artist_terms,artist_terms_freq,artist_term_weight,"
			+ "duration,end_of_fase_in,key,key_confidence,loudness,mode,"
			+ "mode_confidence,start_of_fade_out,tempo,time-signature,"
			+ "time_signature_confidence,time_signature_confidence,"
			+ "segments_start_length,segments_confidence_length,"
			+ "segments_pitches_length,segments_timbre_length,"
			+ "segments_loudness max_length,"
			+ "segments_loudness_max_time_length,"
			+ "segments_loudness_start_length,sections_start_length,"
			+ "sections_confidence_length,beats_start_length,"
			+ "beats_confidence_length,bars_start_length,"
			+ "bars_confidence_length.tatums_start, length,"
			+ "tatums_confidence_length,year,artists_mbtags_length,"
			+ "artists_mbtags_count_length";
	public static String analysis ="bars_confidence,bars_start,beats_confidence,"
			...
			+ "segments_pitches,segments_start,segments_timbre,songs";
	public static String anlaysisSongs = "analysis_sample_rate,audio_md5,"
	...
	public static String metadataSongs = "analyzer_version,artist_7digitalid,"
			+ "artist_familiarity,artist_hotttnesss,artist_id,artist_latitude,"
			+ "artist_location,artist_longitude,artist_mbid,artist_name,"
			+ "artist_playmeid,genre,"
			//+ "idx_artist_terms,idx_similar_artists,"
			+ "release,release_7digitalid,song_hotttness,song_id,title,"
			+ "track_7digitalid,";
	public static String musicbrainz = "artist_mbtags,artist_mbtags_count,songs";
	/**
	 * Opens an existing HDF5 file with read only access.
	 */
	public static H5File hdf5_open_readonly(String filename)
	{
		String path_to_jhdf5_dll="/Users/poojasrinivas/Desktop/Developement/Hdf5Project/lib/libjhdf5.2.10.1.dylib";
		java.lang.System.setProperty("ncsa.hdf.hdf5lib.H5.hdf5lib",path_to_jhdf5_dll);
	...
	public static String get_analyzer_version(H5File h5) throws Exception {return get_analyzer_version(h5,0);}
	public static String get_analyzer_version(H5File h5, int songidx) throws Exception
	{
		return get_member_string(h5,songidx,"/metadata/songs","analyzer_version");
	}
	...
	public static String get_location(H5File h5) throws Exception { return get_location(h5, 0); }
	public static String get_location(H5File h5, int songidx) throws Exception {
	...
	public static String get_genre(H5File h5) throws Exception { return get_genre(h5, 0); }
	public static String get_genre(H5File h5, int songidx) throws Exception
	{  
		return get_member_string(h5,songidx,"/metadata/songs","genre");
	}
	...
	public static int get_analysis_sample_rate(H5File h5) throws Exception { return get_analysis_sample_rate(h5, 0); }
	public static int get_analysis_sample_rate(H5File h5, int songidx) throws Exception
	{    
	...
	private H5File objh5;
	public hdf5_getters(String filename) {
		this.objh5 = hdf5_open_readonly(filename);
	}
	
	public String get_track_id() throws Exception 
	{ 
		return get_track_id(this.objh5, 0); 
	}
	
	public double get_danceability() throws Exception { return get_danceability(this.objh5, 0); }
	public double get_duration() throws Exception { return get_duration(this.objh5, 0); }
	public double get_energy() throws Exception { return get_energy(this.objh5, 0); }
	public String get_audio_md5() throws Exception { return get_audio_md5(this.objh5, 0); }
	public double get_loudness() throws Exception { return get_loudness(this.objh5, 0); }
	public double get_song_hotttnesss() throws Exception { return get_song_hotttnesss(this.objh5, 0); }
	public double get_tempo() throws Exception { return get_tempo(this.objh5, 0); }
	public String get_title() throws Exception { return get_title(this.objh5, 0); }
	public int get_year() throws Exception { return get_year(this.objh5, 0); }
